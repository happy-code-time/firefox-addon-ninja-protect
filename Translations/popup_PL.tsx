...
const PL = {
  addToBlacklistIframesIncluds: 'Dodaj do czarnej listy iframes includes',
  removeFromBlacklistIframesIncluds: 'Usuń z czarnej listy iframes includes',
  addToBlacklistCookies: 'Dodaj do czarnej listy plików cookie',
  removeFromBlacklistCookies: 'Usuń z czarnej listy plików cookie',
  ...
  reset:'Kliknij aby przeprowadzić reset tej wtyczki do ustawień fabrycznych. Wszystkie twoja dane z list, ustawienia i statystyka zostana usunięte. Przejdz najpierw do działu eksportu danych aby po tym resecie móc wykonać import danych.',
  menu_title_ninja: 'Ikonka Ninja',
  ninjaIcon: 'Ikonka tego rozszerzenia została wzięta z',
  turnOn: 'Włącz Protector',
  turnOff: 'Wyłącz Protector',
  links: 'Linki',
  ...
  upload: 'Przeciągnij i upuść plik json Protector tutaj...',
  export: 'Eksport',
