...
const EN = {
  addToBlacklistIframesIncluds: 'Add to the black list of iframes includes',
  removeFromBlacklistIframesIncluds: 'Remove from black list of iframes includes',
  addToBlacklistCookies: 'Add to the black list of cookies',
  removeFromBlacklistCookies: 'Remove from black list of cookies',
  ...
  reset:'Click to make an factory reset of this extension. All your custom lists entries, configuration and the global statistic will be deleted, so please make an export of your lists, settings and statistic. After this process make an import from the dashboard page.',
  menu_title_ninja: 'Ninja Icon',
  ninjaIcon: 'Icon of this extensions are token from',
  turnOn: 'Turn Protector on',
  turnOff: 'Turn Protector off',
  links: 'Links',
